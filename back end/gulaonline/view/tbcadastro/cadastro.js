...
function editUsuario(u) {
    ...
    u.parentNode.parentNode.cells[12].innerHTML = "<select id='idti_lo'>'<option value='1'>1 - Empeendedor</option>'<option value='2'>2 - Comum</option></select><input type='password' placeholder='Nova Senha' id='senha' /><button onclick='putUsuario(this)'>Enviar</button>";
...
function putUsuario(u) {
    ...
    let idti_lo = u.parentNode.parentNode.cells[11].innerHTML;
